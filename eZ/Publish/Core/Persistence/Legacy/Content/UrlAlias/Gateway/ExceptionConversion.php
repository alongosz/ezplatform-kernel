...
final class ExceptionConversion extends Gateway
{
    ...
    public function updateRow(int $parentId, string $textMD5, int $languageMask, array $values): void
    {
        try {
    ...
    public function loadAutogeneratedEntry(
        ...
        try {
            return $this->innerGateway->loadAutogeneratedEntry($action, $parentId, $languageMask);
        } catch (DBALException | PDOException $e) {
            throw DatabaseException::wrap($e);
        }
    }
    ...
    {
        try {
            return $this->innerGateway->loadActionToParentMapForAutogeneratedEntries($actions);
        } catch (DBALException | PDOException $e) {
            throw DatabaseException::wrap($e);
        }
    }
    ...
    public function generateSystemEntry(
        ...
        try {
            $this->innerGateway->generateSystemEntry(
                $action,
                $parentAction,
                $textHash,
                $text,
    ...
    public function updateParent(
        ...
        try {
            $this->innerGateway->updateParent(
                $oldParentId,
                $textHash,
                $languageMask,
                $id,
    ...
    public function archiveActionSystemEntriesNotMatchingHashes(
        ...
        try {
            $this->innerGateway->archiveActionSystemEntriesNotMatchingHashes(
                $action,
                $validHashes
            );
        } catch (DBALException | PDOException $e) {
