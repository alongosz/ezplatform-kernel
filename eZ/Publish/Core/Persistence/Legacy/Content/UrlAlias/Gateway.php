...
abstract class Gateway
{
     ...
     */
    abstract public function updateRow(int $parentId, string $textMD5, int $languageMask, array $values): void;
     ...
     */
    abstract public function loadUrlAliasData(array $urlHashes, ?int $languageMask = null): array;
    ...
    abstract public function generateSystemEntry(
        string $action,
        string $parentAction,
        string $textHash,
        string $text,
    ...
    /**
     * Load a map of a Location action to parent for system (non-alias) entries.
     */
    abstract public function loadActionToParentMapForAutogeneratedEntries(array $actions): array;

    /**
     * Update parent of rows matching specific parent, hash, language mask, and id.
     */
    abstract public function updateParent(
        int $oldParentId,
        string $textHash,
        int $languageMask,
        int $id,
    ...
    abstract public function archiveActionSystemEntriesNotMatchingHashes(
        string $action,
        array $validHashes
    ): void;
}
