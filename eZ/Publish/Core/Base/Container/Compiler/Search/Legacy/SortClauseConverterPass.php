...
class SortClauseConverterPass implements CompilerPassInterface
{
    ...
    public function process(ContainerBuilder $container)
    {
        if (
            ...
            !$container->hasDefinition('ezpublish.search.legacy.gateway.sort_clause_converter.trash')
        ) {
            return;
        }
        ...
        if ($container->hasDefinition('ezpublish.search.legacy.gateway.sort_clause_converter.trash')) {
            $sortClauseConverterTrash = $container->getDefinition('ezpublish.search.legacy.gateway.sort_clause_converter.trash');
